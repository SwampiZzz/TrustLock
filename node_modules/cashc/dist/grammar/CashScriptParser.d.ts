...
export default class CashScriptParser extends Parser {
    ...
    static readonly VersionLiteral = 62;
    static readonly BooleanLiteral = 63;
    static readonly NumberUnit = 64;
    static readonly NumberLiteral = 65;
    static readonly NumberPart = 66;
    static readonly ExponentPart = 67;
    static readonly PrimitiveType = 68;
    static readonly UnboundedBytes = 69;
    static readonly BoundedBytes = 70;
    static readonly Bound = 71;
    static readonly StringLiteral = 72;
    static readonly DateLiteral = 73;
    static readonly HexLiteral = 74;
    static readonly TxVar = 75;
    static readonly UnsafeCast = 76;
    static readonly NullaryOp = 77;
    static readonly Identifier = 78;
    static readonly WHITESPACE = 79;
    static readonly COMMENT = 80;
    static readonly LINE_COMMENT = 81;
    ...
    nonControlStatement(): NonControlStatementContext;
...
export declare class NonControlStatementContext extends ParserRuleContext {
    constructor(parser?: CashScriptParser, parent?: ParserRuleContext, invokingState?: number);
    variableDefinition(): VariableDefinitionContext;
    tupleAssignment(): TupleAssignmentContext;
    assignStatement(): AssignStatementContext;
...
export declare class ControlStatementContext extends ParserRuleContext {
    constructor(parser?: CashScriptParser, parent?: ParserRuleContext, invokingState?: number);
    ifStatement(): IfStatementContext;
    loopStatement(): LoopStatementContext;
    get ruleIndex(): number;
...
export declare class SliceContext extends ExpressionContext {
    _element: ExpressionContext;
...
export declare class TypeNameContext extends ParserRuleContext {
    ...
    BoundedBytes(): TerminalNode;
    UnboundedBytes(): TerminalNode;
    get ruleIndex(): number;
    accept<Result>(visitor: CashScriptVisitor<Result>): Result;
}
export declare class TypeCastContext extends ParserRuleContext {
    constructor(parser?: CashScriptParser, parent?: ParserRuleContext, invokingState?: number);
    PrimitiveType(): TerminalNode;
    UnboundedBytes(): TerminalNode;
    UnsafeCast(): TerminalNode;
    get ruleIndex(): number;
    accept<Result>(visitor: CashScriptVisitor<Result>): Result;
}
