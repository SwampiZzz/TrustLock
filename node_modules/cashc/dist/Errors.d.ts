...
export declare class UnsupportedTypeError extends TypeError {
    constructor(node: BinaryOpNode | UnaryOpNode | TimeOpNode | TupleIndexOpNode | SliceNode, actual?: Type, expected?: Type);
}
...
export declare class IndexOutOfBoundsError extends CashScriptError {
    constructor(node: TupleIndexOpNode | BinaryOpNode | SliceNode);
}
export declare class BitshiftBitcountNegativeError extends CashScriptError {
    constructor(node: BinaryOpNode, bitcount: number);
}
