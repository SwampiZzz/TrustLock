...
(function (GlobalFunction) {
    ...
    GlobalFunction["TO_PADDED_BYTES"] = "toPaddedBytes";
})(GlobalFunction || (GlobalFunction = {}));
export var TimeOp;
(function (TimeOp) {
    TimeOp["CHECK_SEQUENCE"] = "this.age";
    TimeOp["CHECK_LOCKTIME"] = "tx.time";
})(TimeOp || (TimeOp = {}));
export var Class;
(function (Class) {
    Class["LOCKING_BYTECODE_P2SH20"] = "LockingBytecodeP2SH20";
    Class["LOCKING_BYTECODE_P2SH32"] = "LockingBytecodeP2SH32";
...
// Classes
GLOBAL_SYMBOL_TABLE.set(Symbol.class(Class.LOCKING_BYTECODE_P2SH20, new BytesType(23), [new BytesType(20)]));
GLOBAL_SYMBOL_TABLE.set(Symbol.class(Class.LOCKING_BYTECODE_P2SH32, new BytesType(35), [new BytesType(32)]));
...
GLOBAL_SYMBOL_TABLE.set(Symbol.function(GlobalFunction.TO_PADDED_BYTES, new BytesType(), [PrimitiveType.INT, PrimitiveType.INT]));
