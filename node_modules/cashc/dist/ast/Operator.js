...
(function (UnaryOperator) {
    ...
    UnaryOperator["INPUT_TOKEN_CATEGORY"] = "tx.inputs[i].tokenCategory";
    UnaryOperator["INPUT_NFT_COMMITMENT"] = "tx.inputs[i].nftCommitment";
    UnaryOperator["INPUT_TOKEN_AMOUNT"] = "tx.inputs[i].tokenAmount";
    UnaryOperator["OUTPUT_TOKEN_CATEGORY"] = "tx.outputs[i].tokenCategory";
    UnaryOperator["OUTPUT_NFT_COMMITMENT"] = "tx.outputs[i].nftCommitment";
