...
import { FailedTransactionError, TransactionFeeTooHighError, TransactionFeePerByteTooHighError, TransactionFeePerByteTooLowError, TransactionInputsRequiredError, TransactionOutputsRequiredError, UnlockingBytecodeTooLargeError, TransactionTooLargeError, } from './Errors.js';
...
export class TransactionBuilder {
    ...
    buildLibauthTransaction(skipChecks = false) {
        ...
        inputScripts.forEach((script, i) => {
            if (!skipChecks)
                this.checkUnlockingBytecodeSize(script);
    ...
    checkUnlockingBytecodeSize(script) {
